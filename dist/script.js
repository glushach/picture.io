...
var calc = function calc(size, material, options, promocode, result) {
  ...
  function changePram(event, elem) {
    elem.addEventListener(event, function (e) {
      ...
      Object(_services_requests__WEBPACK_IMPORTED_MODULE_0__["getResource"])('../../assets/calcPrice.json').then(function (result) {
        calcFunc(result);
      }).catch(function (e) {
...
var drop = function drop() {
  ...
  //  * срабатываю на элементе, который мы перетаскиваем, а это не наш случай
  // мы будем перетаскивать файлы из файловой системы ПК, место того, чтобы работать с DOM прямо на странице
  ...
  fileInputs.forEach(function (input) {
    input.addEventListener('drop', function (e) {
      input.files = e.dataTransfer.files; // if (input.getAttribute('data-upload')) {
      //     e.preventDefault();
      //     e.stopPropagation();
...
var filter = function filter() {
  ...
  var typeFilter = function typeFilter(markType) {
    ...
    no.style.display = 'none', no.classList.remove('animated', 'fadeIn');
...
var forms = function forms() {
  var form = document.querySelectorAll('form'),
      ...
      upload = document.querySelectorAll('[name="upload"]'); //call function
...
var modals = function modals() {
  ...
  openByScroll('.fixed-gift'); //call function showModalByTime
...
var scrolling = function scrolling(upSelector) {
  ...
  var links = document.querySelectorAll('[href^="#"]'),
      speed = 0.3; // если замедлить скорость, то увелить speed 
  ...
  //       speed;
  //   if (to > from) {
  //     speed = 30; // если нужно замедлить, то нужно уменьшить 30 и -30
  //   } else {
  //     speed = -30;
  //   }
